...
public final class FactoringUtilityTest {
    ...
    public void aFactorTest1() {
         ...
         */
        int n = 0;
        int factor = FactoringUtility.aFactor(n); // violation n > 0
        /*
    ...
    public void aNonTrivialFactorV1Test2() {
         ...
         * Set up variables and call method under test
         */
        int n = 17; // should not be prime number!
        int factor = FactoringUtility.aNonTrivialFactorV1(n);
        /*
         * Assert that values of variables match expectations
         */
    ...
    public void aNonTrivialFactorV1Test3() {
         ...
         * Set up variables and call method under test
         */
        int n = 32; // original code cannot resolve when n = 2^k
        int factor = FactoringUtility.aNonTrivialFactorV1(n);
        /*
         * Assert that values of variables match expectations
         */
    ...
    public void aNonTrivialFactorV2Test2() {
        ...
        assertTrue(1 < factor);
        assertTrue(factor < n);
        assertEquals(0, n % factor); // factor always add one at the end
    }
    ...
    public void aNonTrivialFactorV2Test3() {
        ...
        assertTrue(1 < factor);
        assertTrue(factor < n);
        assertEquals(0, n % 0);// n % 0 is a run time error, divide by zero
    }
